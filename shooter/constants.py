...
# ці лічильники зроблені у вигляді списків, а не змінних, оскільки нам треба, аби зміни в одному місці міняли список всюди
# список, який зберігає бали
scores = [0]
# список, який зберігає кількість пропущених ворогів
miss = [0]
